...
var='degraded_sosstsst'
newvar='sst'
file=rawdatapath+"/ref/NATL20-CJM165_y2012m10d01-y2013m09d30.1d_SST.nc"
newfile=datapath+"/"+domain+"/ref/"+"NATL60-CJM165_"+domain+"_sst_y2013.1y.tmp.nc"
...
# rebuild xarray
newmap = xr.Dataset(\
               data_vars={newvar  : (('time_counter','y','x'),sst),
...
newmap = xr.Dataset(\
               ...
               coords={'lon': np.unique(np.sort(map_.lon.values)),\
                       ...
                       'time': time})
newfile=datapath+"/"+domain+"/ref/"+"NATL60-CJM165_"+domain+"_sst_y2013.1y.nc"
newmap.to_netcdf(newfile,mode='w',unlimited_dims=["time"])

...
#SBATCH --output=build_dataset%j.out     # nom du fichier de sortie
#SBATCH --error=build_dataset%j.err      # nom du fichier erreur (ici commun avec la sortie)
...
# exécution du code
cd /linkhome/rech/genimt01/uba22to/NATL60/scripts/scripts_data
#./build_Dataset.sh $1
#python -u $HOME/NATL60/scripts/scripts_data/convertNadirSwot_to_daily.py $1
python -u $HOME/NATL60/scripts/scripts_data/regrid_Dataset.py ${1}

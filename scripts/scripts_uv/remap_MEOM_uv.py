...
var='v'
newvar='v'
file="/gpfsstore/rech/yrf/uba22to/NATL60_raw/u_v/NATL60-CJM165_v_y2013.1y.nc"
newfile=datapath+"/"+domain+"/ref/"+"NATL60-CJM165_"+domain+"_v_y2013.1y.tmp.nc"
...
# rebuild xarray
newmap = xr.Dataset(\
               data_vars={newvar  : (('time_counter','y','x'),v),
...
newmap = xr.Dataset(\
               ...
               coords={'lon': np.unique(np.sort(map_.lon.values)),\
                       ...
                       'time': time})
newfile=datapath+"/"+domain+"/ref/"+"NATL60-CJM165_"+domain+"_v_y2013.1y.nc"
newmap.to_netcdf(newfile,mode='w',unlimited_dims=["time"])
